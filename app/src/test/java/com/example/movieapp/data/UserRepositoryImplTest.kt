...
class UserRepositoryImplTest {
    ...
    @Test
    fun `getUser maps dto to domain user`() =
        runTest {
    ...
    @Test
    fun `getUser maps null optional fields to empty strings`() =
        runTest {
            coEvery { apiService.getUser() } returns
                fakeDto.copy(
                    name = null,
                    email = null,
                    city = null,
    ...
    @Test
    fun `updateUser sends correct request body and returns mapped user`() =
        runTest {
    ...
    @Test
    fun `updateUser propagates exception from api`() =
        runTest {
    ...
    @Test
    fun `uploadProfilePicture sends multipart with field name 'file' and returns mapped user`() =
        runTest {
            val uri = mockk<Uri>()
    ...
    @Test
    fun `uploadProfilePicture uses mime type from uriReader`() =
        runTest {
            val uri = mockk<Uri>()
    ...
    @Test
    fun `uploadProfilePicture propagates exception from uriReader`() =
        runTest {
            val uri = mockk<Uri>()
    ...
    @Test
    fun `uploadProfilePicture propagates api exception`() =
        runTest {
            val uri = mockk<Uri>()
