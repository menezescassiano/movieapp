...
class AuthRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun hasSavedToken(): Boolean = tokenLocalDataSource.getRefreshToken() != null

        override suspend fun getSavedCredentials(): SavedCredentials? = credentialsDataSource.get()

        override suspend fun clearSavedCredentials() = credentialsDataSource.clear()
    }
